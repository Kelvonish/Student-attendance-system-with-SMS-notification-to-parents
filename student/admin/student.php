  ...
  <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="form-group">
            <div class="row">
              <label class="col-md-4 text-right">Admission No. <span class="text-danger">*</span></label>
              <div class="col-md-8">
          ...
          <div class="form-group">
            <div class="row">
              <label class="col-md-4 text-right">Parent Mobile number. <span class="text-danger">*</span></label>
              <div class="col-md-8">
                <input type="text" name="parent_number" id="parent_number" class="form-control" required/>
                <span id="error_parent_number" class="text-danger"></span>
              </div>
            </div>
          </div>
          <div class="form-group">
