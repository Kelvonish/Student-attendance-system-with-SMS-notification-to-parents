	...
	if($_POST["action"] == 'Add' || $_POST["action"] == "Edit")
	{
		...
		else
		{
			if($_POST["action"] == 'Add')
			{
				...
				(student_name, student_roll_number, student_dob, student_grade_id,parent_number) 
				VALUES (:student_name, :student_roll_number, :student_dob, :student_grade_id, :parent_number)
				";
